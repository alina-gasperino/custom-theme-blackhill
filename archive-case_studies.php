...
<section class="case_studies_hero hero__<?php echo $number_of_columns; ?>-column" style="background-image: url('<?php echo $desktop_background_image['url']; ?>');">
    ...
    <div class="container container-wide flex row afc">
        <?php if($number_of_columns > 1): ?>
            <div class="item_1_2">
                <?php if(!empty($subheading)): ?><h3 class="hero__col_heading"><?php echo $subheading; ?></h3> <?php endif; ?>
                <?php if(!empty($column_heading)): ?><h1 class="hero__heading"><?php echo $column_heading; ?></h1> <?php endif; ?>                
                <?php if(!empty($column_content)): ?><h4 class="hero__col_content"><?php echo $column_content; ?></h4> <?php endif; ?>
